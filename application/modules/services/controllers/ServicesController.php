    ...
    public function listAction() {
        ...
        switch ($this->_getParam('typeid')) {
            case $types->find('installation', 'acronym')->id:
                ...
                $this->view->rowNo = 2;
                $columns = array('planneddate', 'timefrom', 'servicetype', 'calendar', 'number', 'clientid', /* 'clientcity', */ 'clientcity', 'technician', 'documentspassed', 'closedupc', 'status', 'performed');
